...
namespace Training.Trainer
{
    public partial class QuestionBankUpload : System.Web.UI.Page
    {
            ...
            EventArgs e)
        {
            string filePath =
                Server.MapPath(
                "~/Sample/QuestionBankSample.xlsx");
    ...
    string language)
        ...
        {
            string sql =
                "SELECT COUNT(*) FROM QuestionBank QB INNER JOIN CourseMaster CM ON QB.CourseID=CM.CourseID INNER JOIN TopicMaster TM ON QB.TopicID=TM.TopicID WHERE CM.CourseName=@CourseName AND TM.TopicName=@TopicName AND QB.Question=@Question AND QB.QuestionOwnerType='Trainer' AND QB.OwnerID = @OwnerID";
            SqlParameter[] parameter =
            {
        new SqlParameter(
            "@CourseName",
