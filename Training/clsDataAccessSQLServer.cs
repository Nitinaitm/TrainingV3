...
/// </summary>
public class clsDataAccessSQLServer
{
    ...
    //public clsDataAccessSQLServer()
    //{
    //    NpgsqlConnection conn = new NpgsqlConnection("Host=localhost;Port=5432;Database=BSPHCL;Username=postgres;Password=postgres");
