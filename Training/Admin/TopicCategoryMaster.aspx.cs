...
{
    public partial class TopicCategoryMaster : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT ISNULL(MAX(ID),0)+1 FROM TopicCategoryMaster", con);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT CategoryID,CategoryName,Remarks, CreatedOn FROM TopicCategoryMaster ORDER BY ID DESC", con);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmdCheck = new SqlCommand("SELECT COUNT(*) FROM TopicCategoryMaster WHERE CategoryName=@CategoryName", con);
            ...
            SqlCommand cmd = new SqlCommand(@"INSERT INTO TopicCategoryMaster
    (
        CategoryID,
        CategoryName,
    ...
    (
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM TopicCategoryMaster WHERE CategoryID=@CategoryID", con);
        ...
        {
            SqlCommand chk = new SqlCommand("SELECT COUNT(*) FROM TopicMaster WHERE Category=@CourseCategory", con);
            ...
            SqlCommand cmd = new SqlCommand("DELETE FROM TopicCategoryMaster WHERE CategoryID=@CategoryID", con);
        ...
        {
            SqlCommand chk = new SqlCommand("SELECT COUNT(*) FROM TopicCategoryMaster WHERE CategoryName=@CategoryName AND CategoryID<>@CategoryID", con);
            ...
            SqlCommand cmd = new SqlCommand(@"UPDATE TopicCategoryMaster SET
...
WHERE CategoryID=@CategoryID", con);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (Used > 0)
            {
                ...
                lblMessage.Text = "Topic Category is already assigned to Batch. Delete not allowed.";
...
ORDER BY CategoryName", con);
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=TopicyMaster.xlsx");
