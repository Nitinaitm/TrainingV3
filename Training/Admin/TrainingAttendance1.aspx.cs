...
{
    public partial class TrainingAttendance1 : System.Web.UI.Page
    {
        string constr =
...
B.EmpName,
B.EmpDesignation,
ISNULL(A.TrainingAttended,'') AS TrainingAttended
...
(
    @Search=''
    OR A.EmpID LIKE '%'+@Search+'%'
    OR B.EmpName LIKE '%'+@Search+'%'
    OR B.EmpDesignation LIKE '%'+@Search+'%'
)
