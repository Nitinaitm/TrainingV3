...
.cp-toolbar .btn-action{min-width:220px;margin-right:10px;margin-bottom:10px;padding:12px 28px;font-size:18px;font-weight:600;border-radius:8px;box-shadow:0 3px 8px rgba(0,0,0,.15)}
