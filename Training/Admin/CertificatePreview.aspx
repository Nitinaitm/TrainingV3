...
.preview-page{padding:10px 0 30px}
...
.logo,.header,.title,.body,.footer,.signature{position:absolute;box-sizing:border-box}
.logo{width:90px;height:90px;object-fit:contain}
.header{left:80px;right:80px;text-align:center;font-weight:bold;line-height:1.25;white-space:normal}
.title{left:60px;right:60px;text-align:center;font-weight:bold;line-height:1.2}
.body{left:90px;right:90px;text-align:center;line-height:1.25}
.body-intro,.body-completion,.body-duration{display:block}
.trainee-name{font-size:30px;font-weight:bold;display:block;margin:16px 0 16px;line-height:1.15}
.course-title{font-size:24px;font-weight:bold;display:block;margin:16px 0 12px;line-height:1.2}
.duration{display:block;margin-top:10px}
.signature{top:auto;width:220px;text-align:center}
.signature img{width:180px;height:70px;object-fit:contain;display:block;margin:0 auto}
.sign-name{font-weight:bold;margin-top:5px;line-height:1.2}
.sign-designation{font-size:15px;line-height:1.2;margin-top:3px}
.footer{left:60px;right:60px;text-align:center;line-height:1.2;white-space:normal}
...
<div class="container-fluid preview-page">
    ...
    <div class="certificate-wrap">
        <div id="divCertificate" runat="server" class="certificate">
            ...
            <div id="divLeftSignature" runat="server" class="signature">
            ...
            <div id="divRightSignature" runat="server" class="signature">
