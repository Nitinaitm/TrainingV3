...
public class clsDataAccessSMS
{
    ...
    public clsDataAccessSMS()
    {
        con.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SMSConnectionString"].ConnectionString;
